...
<p>
  谨向模板作者石青学长，以及其所做工作表示由衷的感谢。
</p>

</div>

本 Skill 依赖于原模板工作，如果没有它，本 Skill 也无从立足。本项目所做的，只是在原模板的基础上，为它补充更适合普通学生使用的 Agent Skill，让不会 LaTeX 的人，也能先享受到 LaTeX 规范排版带来的便利。

<details>
<summary>🤔 我为什么要做这个项目？（强烈推荐看看！）</summary>
